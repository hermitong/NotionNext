const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>旅居欧洲，业余交易，读书写字，记录生活<br/>———————— ————————<br/>You have to trust that the dots will somehow connect in your future.</div>',
